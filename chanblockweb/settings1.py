...
SECRET_KEY = 'django-insecure-uo9kw(%+f(4(truf+=ncl!r*scnc1u6z#2=y)uzg$$i6w3_+(-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = FALSE

ALLOWED_HOSTS = ['127.0.0.1','www.chanblock.com','chanblock.com','chanblockweb-env.eba-zqsambp9.us-west-2.elasticbeanstalk.com']
